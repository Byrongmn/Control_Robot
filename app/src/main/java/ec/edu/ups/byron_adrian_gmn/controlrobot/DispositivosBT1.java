...
public class DispositivosBT1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dispositivos_bt1);
    }
    @Override
    public void onResume() {
        ...
        IdLista = (ListView) findViewById(R.id.Dispositivoslist);
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView av, View v, int arg2, long arg3) {
            ...
            Intent i = new Intent(DispositivosBT1.this, MainActivity.class);//<-<- PARTE A MODIFICAR >->->
